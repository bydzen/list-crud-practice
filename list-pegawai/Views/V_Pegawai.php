...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-header bg-secondary text-white d-flex justify-content-between">
                Data Pegawai
                <a href="<?= base_url('/') ?>" class="text-white text-decoration-none fw-bold">Refresh &circlearrowleft;</a>
            </div>
            <div class="card-body">
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm" style="margin-left: 10px;" onclick="hapus(<?php echo $v['id'] ?>)">Delete</button>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    <?php if ($nomor > 1) { ?>
                        <button type="button" class="btn btn-danger btn-sm" onclick="hapusSemua()">Delete All</button>
                    <?php } ?>
                </table>
                <?php
    ...
    <script>
        ...
        function hapusSemua() {
            var result = confirm('Yakin mau melakukan proses delete semua data?');
            if (result) {
                window.location = "<?php echo site_url("pegawai/hapusSemua") ?>";
            }
        }
