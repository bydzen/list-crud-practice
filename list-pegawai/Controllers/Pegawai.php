...
class Pegawai extends BaseController
{
    ...
    {
        $this->model = new \App\Models\M_Pegawai();
    }
    ...
    public function index()
    {
        ...
        $data['nomor'] = ($this->request->getVar('page') == 2) ? '5' : $data['nomor'];
        $data['nomor'] = ($this->request->getVar('page') == 3) ? '10' : $data['nomor'];
